...
export default function CopyButton({
  ...
  return (
    <button
      onClick={handleCopy}
      className={`flex items-center gap-2 px-3 py-1.5 bg-neutral-800 hover:bg-neutral-700 rounded-md transition-colors text-xs font-medium text-neutral-300 group ${className}`}
      title={text}
    >
      <span>{label}</span>
      {copied ? (
